...
setup(
    ...
    author='Isaac Flath',
    author_email='isaac@vinculum.solutions',
    url='https://github.com/vinculum-solutions/vinculum',
    download_url='https://github.com/vinculum-solutions/vinculum/archive/v_01.tar.gz',
    license='MIT',
